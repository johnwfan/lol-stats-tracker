    ...
    <footer className="mt-auto border-t border-border bg-card/60">
      ...
      <div className="border-t border-border">
        <div className="mx-auto max-w-5xl px-4 py-4 text-center text-[11px] leading-relaxed text-text-muted">
          <p>
            scuttle.gg isn&apos;t endorsed by Riot Games and doesn&apos;t reflect the views or opinions of Riot
          ...
          <p className="mt-1">© {new Date().getFullYear()} scuttle.gg. Built for fun by John Fan.</p>
        </div>
      </div>
    </footer>
  );
